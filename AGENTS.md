...
Never patch `vendor/dillonsmart/tetherphp-core` — it is overwritten on the next install. See
[`docs/agents/linked-core-development.md`](docs/agents/linked-core-development.md) for changing framework code
